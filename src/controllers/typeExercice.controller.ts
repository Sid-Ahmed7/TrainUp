...
export const getTypeExercice = async (req: Request, res: Response) => {
    const exercice = await typeExerciceService.findTypeExerciceById(Number(req.params.id))
...
export const updateTypeExercice = async (req: Request, res: Response) => {
    ...
    try {
        const updatedTypeExercice = await typeExerciceService.updateTypeExercice(id, dto);
